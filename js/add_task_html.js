    ...
    return /*html*/`
            <div id="task-input-left" class="task-input-left">
              ...
              <div class="task-assigned-to-con">
                <label class="task-label"  style="margin-bottom:8px">Assigned to</label>
                <div class="task-assigned-to-con">
                  <input type="button" value="Select contacts to assign" 
                  onclick="stopClosing(event), showAssignedToBt(), addEventListenersToCheckboxes()" 
                ...
                <div id="task-assigned-to-selected-con" class="task-assigned-to-selected-con"></div>
              </div>
            </div>
